...
export const env = {
  ...
  // ---- Email (Resend — free tier 3,000/mo). Customer OTP + reminders are
  // email-only; there is no SMS/WhatsApp provider. ----
  ...
  vapidSubject: process.env.VAPID_SUBJECT ?? 'mailto:hello@rewrd.online',
