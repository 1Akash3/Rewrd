  ...
  return (
    <main className="mx-auto max-w-3xl px-5 py-12 prose-sm">
      ...
      <div className="mt-6 space-y-4 text-sm leading-relaxed text-ink">
        <p>Rewrd helps local businesses run digital loyalty programs. We process the minimum data needed to deliver stamps and rewards: your mobile number, optional name/email, and your stamp/reward activity.</p>
