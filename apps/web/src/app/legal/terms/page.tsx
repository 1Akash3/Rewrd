  ...
  return (
    <main className="mx-auto max-w-3xl px-5 py-12">
      ...
      <div className="mt-6 space-y-4 text-sm leading-relaxed text-ink">
        <p>By using Rewrd you agree to these terms. Rewrd is a B2B SaaS platform; merchants subscribe monthly and end customers use the service free of charge.</p>
        ...
        <p>Subscriptions are billed monthly. A free trial is provided without payment collection. Cancellations take effect at the end of the current term; grace periods apply to failed payments.</p>
